...
const App: React.FC = () => {
  ...
  const handleStartSearching = () => {
    ...
    if (propertyStatus?.missing.length! > 0 || propertyStatus?.typeErrors.length! > 0) {
          ...
          {step === 'config' ? (
            <div className="flex flex-col h-full animate-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-4 flex-1 overflow-y-auto custom-scrollbar pr-1">
                ...
                {propertyStatus && (propertyStatus.missing.length > 0 || propertyStatus.typeErrors.length > 0) && (
